...
Fixpoint add_variables (vars : list dec) (m:memory_stack) (l:local_env) (g:global_env) : (memory_stack * (local_env * (global_env * unit))) :=
match vars with
| nil => (m, (l, (g, tt)))
| h :: t => match h with
            | Var x =>
...
Fixpoint add_variables_2 (vars : list dec) (m:memory_stack) (l:local_env) (g:global_env) : (memory_stack * (local_env * (global_env * unit))) :=
match vars with
| nil => (m, (l, (g, tt)))
| h :: t => match h with
            | Var x =>
...
Fixpoint add_variables_itree_2 (vars : list dec) (m:memory_stack) (l:local_env) (g:global_env) : itree (CallE +' PickE +' UBE +' DebugE +' FailureE) (memory_stack * (local_env * (global_env * unit))) :=
match vars with
| nil => Ret (m, (l, (g, tt)))
| h :: t => match h with
            | Var x =>
...
Fixpoint add_variables_itree (vars : list dec) (m:memory_stack) (l:local_env) (g:global_env) : itree (CallE +' PickE +' UBE +' DebugE +' FailureE) (memory_stack * (local_env * (global_env * unit))) :=
match vars with
| nil => Ret (m, (l, (g, tt)))
| h :: t => match h with
            | Var x =>
